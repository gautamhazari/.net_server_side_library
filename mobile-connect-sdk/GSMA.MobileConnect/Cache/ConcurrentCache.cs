...
namespace GSMA.MobileConnect.Cache
{
    ...
    /// </summary>
    public abstract class ConcurrentCache : BaseCache
    {
        protected readonly ConcurrentDictionary<string, string> _internalCache =
        ...
        protected long CacheSize => new BinaryFormatter.BinaryConverter().Serialize(_internalCache).Length;
        ...
        protected async Task CleanCacheAsync()
        {
