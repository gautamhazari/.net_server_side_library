...
namespace GSMA.MobileConnect.Discovery
{
    ...
    public interface IDiscoveryService
    {
        ...
        /// <summary>
        /// Synchronous wrapper for <see cref="IDiscoveryService.StartAutomatedOperatorDiscoveryAsync(IPreferences, string, DiscoveryOptions, IEnumerable{BasicKeyValuePair})"/>
        /// </summary>
        ...
        /// <summary>
        /// Convenience version of <see cref="IDiscoveryService.StartAutomatedOperatorDiscoveryAsync(string, string, string, string, DiscoveryOptions, IEnumerable{BasicKeyValuePair})"/>
        ...
        /// <summary>
        /// Synchronous wrapper for <see cref="IDiscoveryService.GetOperatorSelectionURLAsync(string, string, string, string)"/>
        /// </summary>
        ...
        /// <summary>
        /// Synchronous wrapper for <see cref="IDiscoveryService.GetOperatorSelectionURLAsync(IPreferences, string)"/>
        /// </summary>
        /// <param name="preferences">Instance of IPreferences that provides clientId, clientSecret and discoveryUrl (Required)</param>
        /// <param name="redirectUrl">The URL the operator selection functionality redirects to. (Required)</param>
        ...
        /// <summary>
        /// Convenience wrapper for <see cref="IDiscoveryService.GetOperatorSelectionURLAsync(string, string, string, string)"/>
        /// where the clientId, clientSecret and discoveryUrl are provided by the IPreferences implementation
        /// </summary>
        /// <param name="preferences">Instance of IPreferences that provides clientId, clientSecret and discoveryUrl (Required)</param>
        /// <param name="redirectUrl">The URL the operator selection functionality redirects to. (Required)</param>
        ...
        /// <summary>
        /// Synchronous wrapper for <see cref="IDiscoveryService.CompleteSelectedOperatorDiscoveryAsync(string, string, string, string, string, string)"/>
        /// </summary>
        /// <param name="clientId">The registered application clientId (Required)</param>
        /// <param name="clientSecret">the registered application client secret (Required)</param>
        /// <param name="discoveryUrl">The URL of the discovery endpoint (Required)</param>
        ...
        /// <summary>
        /// Synchronous wrapper for <see cref="IDiscoveryService.CompleteSelectedOperatorDiscoveryAsync(IPreferences, string, string, string)"/>
        /// </summary>
        /// <param name="preferences">Instance of IPreferences that provides clientId, clientSecret and discoveryUrl (Required)</param>
        /// <param name="redirectUrl">The registered application redirect url (Required)</param>
        /// <param name="selectedMCC">The Mobile Country Code of the selected operator. (Required)</param>
        ...
        /// <summary>
        /// Convenience version of <see cref="IDiscoveryService.CompleteSelectedOperatorDiscoveryAsync(string, string, string, string, string, string)"/>
        /// where the clientId, clientSecret and discoveryUrl are provided by the IPreferences implementation
        /// </summary>
        /// <param name="preferences">Instance of IPreferences that provides clientId, clientSecret and discoveryUrl (Required)</param>
        /// <param name="redirectUrl">The registered application redirect url (Required)</param>
