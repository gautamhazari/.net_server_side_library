...
namespace GSMA.MobileConnect.Authentication
{
    ...
    public interface IAuthenticationService
    {
        ...
        StartAuthenticationResponse StartAuthentication(string clientId, string correlationId, string authorizeUrl, string redirectUrl, string state, string nonce, string encryptedMsisdn, SupportedVersions versions, AuthenticationOptions options);
        ...
        Task<RequestTokenResponse> RequestHeadlessAuthentication(string clientId, string clientSecret, string correlationId, string authorizeUrl, string tokenUrl, string redirectUrl,
        ...
        /// <summary>
        /// Synchronous wrapper for <see cref="IAuthenticationService.RequestTokenAsync(string, string, string, string, string, string)"/>
        /// </summary>
        /// <param name="clientId">The registered application ClientId (Required)</param>
        ...
        RequestTokenResponse RequestToken(string clientId, string clientSecret, string correlationId, string requestTokenUrl, string redirectUrl, string code);
        ...
        /// <param name="redirectUrl">Confirms the redirectURI that the application used when the authorization request (Required)</param>
        /// <param name="code">The authorization code provided to the application via the call to the authentication/authorization API (Required)</param>
        Task<RequestTokenResponse> RequestTokenAsync(string clientId, string clientSecret, string correlationId, string requestTokenUrl, string redirectUrl, string code);
